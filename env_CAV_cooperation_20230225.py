...
class Network():
    def __init__(self):
        ...
        self.distances = np.arange(3,33,3) # All candidate states for transmitter-receiver distances
        # state transition prob. matrix for distance states
        self.trans_matrix = np.array([[0.21, 0.172, 0.141, 0.115, 0.094, 0.077, 0.063, 0.052, 0.042, 0.034],
                                [0.151, 0.184, 0.151, 0.124, 0.101, 0.083, 0.068, 0.056, 0.045, 0.037],
                                [0.114, 0.139, 0.17, 0.139, 0.114, 0.093, 0.076, 0.062, 0.051, 0.042],
                                [0.089, 0.108, 0.132, 0.161, 0.132, 0.108, 0.089, 0.073, 0.059, 0.049],
                                [0.071, 0.087, 0.106, 0.129, 0.158, 0.129, 0.106, 0.085, 0.071, 0.058],
                                [0.057, 0.071, 0.087, 0.106, 0.129, 0.158, 0.129, 0.106, 0.086, 0.071],
                                [0.049, 0.059, 0.073, 0.089, 0.108, 0.132, 0.161, 0.132, 0.108, 0.089],
                                [0.042, 0.051, 0.062, 0.076, 0.093, 0.114, 0.139, 0.17, 0.139, 0.114],
                                [0.037, 0.045, 0.056, 0.068, 0.083, 0.101, 0.124, 0.151, 0.184, 0.151],
                                [0.035, 0.042, 0.052, 0.063, 0.077, 0.094, 0.115, 0.141, 0.172, 0.209 ]])
    ...
    def reset(self):
        ...
        self.O_vehs_all = np.array([4,4,4])
        O_norm = (self.O_vehs_all - np.array([4,4,4]))/4
           
        
        ############################# Distance and channel gain ###############################################
        
        self.Distance_all = np.array([9,9,9])
        Distance_norm = (self.Distance_all - np.array([3,3,3]))/30
    ...
    def step(self, curr_action):
        ...
        for i_agent in range(0, self.n_agents): 
            p = self.trans_matrix[int(self.Distance_all[i_agent]/3-1),:]           

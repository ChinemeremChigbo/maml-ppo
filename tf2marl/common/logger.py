...
class RLLogger(object):
    ...
    def experiment_end(self,q_loss_all,pol_loss_all,train_steps_plot):
        ...
        # sio.savemat(file_name, {"final_ep_rewards": np.array(self.final_ep_rewards), "final_ep_ag_rewards": np.array(self.final_ep_ag_rewards),"episode_rewards": np.array(self.episode_rewards),"agent_rewards": np.array(self.agent_rewards),"q_loss_all": np.array(q_loss_all),"pol_loss_all": np.array(pol_loss_all),"train_steps_plot": np.array(train_steps_plot)})
        sio.savemat(file_name, {"episode_rewards": np.array(self.episode_rewards),"episode_objs": np.array(self.episode_objs),"episode_switchs": np.array(self.episode_switchs),"q_loss_all": np.array(q_loss_all),"pol_loss_all": np.array(pol_loss_all),"train_steps_plot": np.array(train_steps_plot)})

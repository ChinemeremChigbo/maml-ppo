...
class RLLogger(object):
    ...
    def experiment_end(self,q_loss_all,pol_loss_all,train_steps_plot,episode_rewards_BF_optimal,episode_objs_BF_optimal,episode_switches_BF_optimal,episode_rewards_random,episode_objs_random,episode_switches_random,episode_rewards_modified):
        ...
        sio.savemat(file_name, {"episode_rewards": np.array(self.episode_rewards),"episode_objs": np.array(self.episode_objs),"episode_switchs": np.array(self.episode_switchs),"episode_rewards_BF_optimal": np.array(episode_rewards_BF_optimal),"episode_objs_BF_optimal": np.array(episode_objs_BF_optimal),"episode_switches_BF_optimal": np.array(episode_switches_BF_optimal),"episode_rewards_random": np.array(episode_rewards_random),"episode_objs_random": np.array(episode_objs_random),"episode_switches_random": np.array(episode_switches_random),"q_loss_all": np.array(q_loss_all),"pol_loss_all": np.array(pol_loss_all),"train_steps_plot": np.array(train_steps_plot),"episode_rewards_modified": np.array(episode_rewards_modified)})

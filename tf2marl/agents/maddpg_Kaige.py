...
class MADDPGAgent_Kaige(AbstractAgent):
    def __init__(self, obs_space_n, act_space_n, agent_index, batch_size, buff_size, lr_c, lr_a, num_layer, num_units, gamma,
        ...
        self.critic = MADDPGCriticNetwork(num_layer, num_units, lr_c, obs_shape_n, act_shape_n, act_type, agent_index)
        self.critic_target = MADDPGCriticNetwork(num_layer, num_units, lr_c, obs_shape_n, act_shape_n, act_type, agent_index)
        self.critic_target.model.set_weights(self.critic.model.get_weights())

        self.policy = MADDPGPolicyNetwork(num_layer, num_units, lr_a, obs_shape_n, act_shape_n[agent_index], act_type, 1,
                                          self.critic, agent_index)
        self.policy_target = MADDPGPolicyNetwork(num_layer, num_units, lr_a, obs_shape_n, act_shape_n[agent_index], act_type, 1,
                                                 self.critic, agent_index)
